...
public class SparkMaxPID {
    ...
    public SparkMaxPID(SparkPIDController pidController) {
        this.pidController = pidController;
    }

    public SparkMaxPID(SparkPIDController pidController, SparkMaxConstants constants) {
        this(pidController);
        this.setConstants(constants);
    }
    ...
    public void setFeedbackDevice(SparkAbsoluteEncoder device) {
        this.pidController.setFeedbackDevice(device);
    }   
